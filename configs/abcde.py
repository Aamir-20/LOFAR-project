...
def save_run_info(n_inputs, learning_rate, batch_size, num_epochs, filename=os.path.basename(__file__)):
    row = [n_inputs, learning_rate, batch_size, num_epochs, filename]
