...
def save_run_info(n_inputs, learning_rate, batch_size, num_epochs, filename=os.path.abspath(__file__)):
    row = f"{n_inputs},{learning_rate},{batch_size},{num_epochs},{filename}"
    path = "/configs/runs.csv"
    with open(path) as f:
...
#save_run_info(n_inputs, learning_rate, batch_size, num_epochs,filename)
...
while True:
    try:
        ...
        if ask.lower() == "y" or ask.lower() == "yes":
            ...
            save_run_info(n_inputs, learning_rate, batch_size, num_epochs)
            break
    except:
        pass
